...
from core.dataset import COCODatasetWithID, COCODatasetGeneral
...
def test(model, annotations_file, imagedir, outdir, outname="test", epoch=None, record_individual_scores=False, print_batch_metrics=False):
    ...
    testset = COCODatasetGeneral(annotations_file, imagedir, image_size=(224,224), normalize_means=[0.485, 0.456, 0.406], normalize_stds=[0.229, 0.224, 0.225])
